      ...
      if (!in_array($this->params['action'], $allowedFunctions)) 
      {
            ...
            {                   
                  ...
                  if (!$this->_authenticate($authorizationHeader)) {
                        ...
                        exit(json_encode(array('status' => false, 'message' => 'Invalid access token.')));
                  }
            }else {
                  header('HTTP/1.0 401 Unauthorized');
...
*******************************************************************************************/
      ...
      */
      public function app_logout()
      {
            ...
            $data       = json_decode($requestArgs,true);            
            //send args to model function
            $logoutData=$this->DeviceToken->appUserLogout($data, $message);            
            if(!$logoutData) {
                  return $this->_returnJson(false, $message);
            }
            else {                  
      ...
      * @Created by  : Rafi (Evon Technologies)
      * @Date       : 31_Oct_2017
      * @param      : string $Data    
	...
	*/
	...
	{     
	 ...
	 /**
      * @access public
      * @Method app_checkUserActivationKey.
      * @Description: Reset user password 
      * @Created by  : Rafi (Evon Technologies)
      * @Date       : 
      * @param      : string $code    
     ...
     /**
      * @access public
      * @Method         : app_getCompanyDetailByCurrentUserId1.
      * @Created by      : Rafi Ahmad(Evon Technologies)
      * @Date           : 24_Nov_2017
      * @description    :
      * @return Company Detail By Current User in Json Format
...
/** Date dec 4, 2017 */
    ...
    /**
      ...
      * @Created by      : Rafi Ahmad(Evon Technologies)
      * @Date           : 
      * @description    :job bid details in Json Format
    ...
    public function app_GetJobBidDetails()
    {
      ...
      * @Created by      : Rafi Ahmad(Evon Technologies)
      * @Date           : 
      * @description    :app_ Get Accept Bid Details
      * @return 
      */
	...
	/**
      * @access public
      * @Method         : app_deleteJobDetails.
      * @Created by      : Rafi Ahmad(Evon Technologies)
      * @Date           : 
      * @description    :app delete Job Details
      * @return
      */
      ...
      */
      ...
      // Not in Use
       /**
      * @access public
      * @Method         : app_getEmployeeJobsByCategoryId.
      * @Created by      : Rafi Ahmad(Evon Technologies)
      * @Date           : 
      * @description    :
      ...
      * @Date           : 
      * @description    :
      * @return app Get JobDetails For Guest in Json Format
      */
      ...
      */
      ...
      /**
      * @access public
      * @Method         : app_GetBookedJobsByCalendar.
      * @Created by      : Rafi Ahmad(Evon Technologies)
      * @Date           : 
      * @description    :
      * @return Job Details in Json Format
      ...
      */
       ...
       /**
      * @access public
      * @Method         : app_checkEmployerPaymentStatusForCurrentJob.
      * @Created by     : Ayush Gupta(Evon Technologies)
      * @Date           : 4th June 2018
      * @description    :
      * @return          User job bid details in Json Format
      */
       public function app_checkEmployerPaymentStatusForCurrentJob()
       {
           // {"jobId": "11","UserId":"47"}// for testing purpose             
            $requestArgs = $this->request->input();
            $data       = json_decode($requestArgs,true);                       
            $userPaymentData=$this->PaymentHistory->appcheckEmployerPaymentStatusForCurrentJob($data, $message);             
            if(!$userPaymentData) {
                  return $this->_returnJson(false, $message);
            }
            else {  
      ...
      */
      public function app_sendContactQuery()
      {
            ...
            if(!empty($email))
            {
                  //send email to admin
             $emailArray =array();
             $emailArray['to']='rafi.ahmad@evontech.com';
      ...
      * @Created by      : Ayush Gupta(Evon Technologies)
      * @Date           : 
      * @description    : Get how it works Details 
      * @return         : details in Json Format
      */
 ...
 */
      ...
      */
      ...
      /**
      * @access public
      * @Method         : app delete Last Bid.
      * @Created by     : Ayush Gupta(Evon Technologies)
      * @Date           : 
      * @description    : delete last bid of the employee.
      * @return  last bid id deleted successfully
      */
      public function app_deleteLastBid(){
            ...
            if(!$bidData) {
                  ...
                  return $this->_returnJson(true,$message,$bidData['lastID']);
            } 
      }
