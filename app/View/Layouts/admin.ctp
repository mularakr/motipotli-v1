...
<html>
    <head>
		...
		<!-- iCheck -->
		<link rel="stylesheet" href="<?=$basepath ?>adminfile/plugins/iCheck/flat/blue.css">
		<!-- Morris chart -->
		<link rel="stylesheet" href="<?=$basepath ?>adminfile/plugins/morris/morris.css">
    	<link rel="stylesheet" href="<?=$basepath ?>adminfile/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    	<link rel="stylesheet" href="<?=$basepath ?>adminfile/plugins/datepicker/datepicker3.css">
    	<link rel="stylesheet" href="<?=$basepath ?>adminfile/plugins/daterangepicker/daterangepicker-bs3.css">
