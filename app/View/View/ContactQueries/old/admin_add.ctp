        ...
        <div class="col-xs-12">
          <div class="box">
			  ...
			  <div class="box box-info">
				 <?php  echo $this->Form->create('Category',array('url'=>array('controller'=>'categories','action'=>'admin_add'),'method'=>'post','class'=>'form-horizontal','type'=>'file','autocomplete'=>'off','enctype'=>'multipart/form-data'));?>
				  <div class="box-body">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<?php echo $this->Form->input('name',array('placeholder'=>'Name','type'=>'text','class'=>'form-control','pattern' => '.*[^ ].*','required'=>'required','label' => false));?>	
					  </div>
					</div>
					<div class="form-group">
