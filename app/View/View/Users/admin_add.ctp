				 ...
				 <?php  echo $this->Form->create('User',array('url'=>array('admin'=>true,'controller'=>'users','action'=>'admin_add'),'method'=>'post','class'=>'form-horizontal','type'=>'file','autocomplete'=>'off','enctype'=>'multipart/form-data'));?>
				  <div class="box-body">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<?php echo $this->Form->input('state_id',array('empty' => '--Select State--','placeholder'=>'State','type'=>'select','id'=>'state','class'=>'form-control','label' => false));?>	
					  </div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
						<?php echo $this->Form->input('phone',array('maxlength'=>'13','placeholder'=>'Phone','type'=>'text','class'=>'form-control','label' => false));?>	
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-10">
					  <!--<?php 
					  echo $this->Form->input('VenueImage.imagename',array('placeholder'=>'Upload a photo','required'=>'required','type'=>'file','id'=>'vimagename','label'=>array('text'=>'Photo upload*'),'div'=>array('class'=>'form-group col-sm-6')));

					  ?>-->
					  <?php echo $this->Form->input('profileimg', array('placeholder'=>'Upload a photo','type' => 'file','id'=>'profileimage','label' => false));
						?>							
					  </div>
					</div>
...
<script type="text/javascript">
	...
	//to check a  profileimage valid image
