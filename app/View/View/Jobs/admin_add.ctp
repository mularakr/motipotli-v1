               ...
               <div class="box box-info">
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                           <?php echo $this->Form->input('title',array('placeholder'=>'Job Title','type'=>'text','class'=>'form-control','pattern' => '.*[^ ].*','label' => false));?>	
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label"><span style="color:black">Positions<span style="color:red">*</span></span></label>
                        <div class="col-sm-10">
                           <?php echo $this->Form->input('positions',array('placeholder'=>'Positions','type'=>'text','class'=>'form-control','pattern' => '.*[^ ].*','label' => false));?>	
                        </div>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <?php echo $this->Form->input('startdate',array('placeholder'=>'Start Date','type'=>'text','class'=>'form-control','id'=>'datetimepicker','label' => false));?>                        
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label"><span style="color:black">End Date<span style="color:red">*</span></span></label>
                        <div class="col-sm-10">
                        <?php echo $this->Form->input('enddate',array('placeholder'=>'End Date','type'=>'text','class'=>'form-control','id'=>'datetimepicker2','label' => false));?>                        
                        </div>
                     </div> 
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <?php echo $this->Form->input('starttime',array('placeholder'=>'Start Time','type'=>'text','class'=>'form-control','id'=>'datetime1','label' => false));?>                        
                        </div>
                     </div>
                     <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label"><span style="color:black">End Time<span style="color:red">*</span></span></label>
                        <div class="col-sm-10">
                        <?php echo $this->Form->input('endtime',array('placeholder'=>'End Time','type'=>'text','class'=>'form-control','id'=>'datetime2','label' => false));?>                        
                        </div>
                     </div>                     
                     <div class="form-group">
...
$(document).ready(function(){
    ...
    jQuery("#JobAdminAddForm").validate({
  rules: {
    'data[Job][title]': { required: true},
    'data[Job][positions]': { required: true},

  },
  messages: {
    'data[Job][title]': {required: "*Title can't be Empty." },
    'data[Job][positions]': {required: "*Positions can't be Empty." },
