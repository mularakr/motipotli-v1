...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = "mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/";
        

    $useruploadfolder = "mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
    ...
    $useruploadfolder = "http://192.168.3.31/mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "http://192.168.3.31/mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
        

    $useruploadfolder = "192.168.3.31/mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "192.168.3.31/mindfulness/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
    ...
    $useruploadfolder = "mindfulness/app/webroot/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "mindfulness/app/webroot/adminfile/plugins/ckeditor/plugins/imageuploader/uploads";
