 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfmIxfd2fs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930975742253542496749683645');
...
//PayUmoney
Configure::write('PAYU_MERCHANT_KEY', 'gtKFFx'); //These are test account details, update it with your live account merchant key
Configure::write('PAYU_MERCHANT_SALT', 'eCwWELxi'); // That is test account salt, update it with your live account salt

//Configure::write('MOTIPOTLI_URL', 'http://52.55.215.33/motipotlipro/');//server
Configure::write('MOTIPOTLI_URL', 'http://localhost:4200/');//Local http://localhost:4200/

Configure::write('MOTIPOTLI_LIVE_URL', 'https://motipotli.com/');//Local http://localhost:4200/



//Configure::write('MOTIPOTLI_URL', 'http://52.55.215.33/motipotlipro/');//server
Configure::write('MY_SALT', 'DYhG93b0qyJfmIxfd2fu2uuVoUubWwvniR2G0FgaC9mi');//Local http://localhost:4200/
